...
import { Customer, CustomerCategory, DiscountCode, Sale, SaleDetail, SalePayment, Quotation, QuotationItem } from './entities';
...
@Module({
  imports: [TypeOrmModule.forFeature([CustomerCategory, Customer, DiscountCode, Sale, SalePayment, SaleDetail, Branch, Product, Quotation, QuotationItem]), LogisticsModule, PurchasesModule, FinanceModule, MailModule, PdfModule],
